...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 13, 2015 at 10:38 AM
...
CREATE TABLE IF NOT EXISTS `prestige_items_roles` (
  ...
  `modified` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=ascii COMMENT='Determines which roles can approve a prestige item.' AUTO_INCREMENT=5 ;
